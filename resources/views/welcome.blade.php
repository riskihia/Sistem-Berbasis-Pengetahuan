...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="p-2 md:w-10/12 mx-auto">
        <div class="top-0 sticky bg-violet-100 py-8">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div>
                <div class="shadow-lg md:w-10/12 mx-auto md:p-2">
                    <p class="p-4 text-lg tracking-wider">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat natus ea at quos ut. Inventore, voluptatem illo accusantium eveniet praesentium perspiciatis modi doloremque, veniam sapiente assumenda pariatur dolore voluptates esse?</p>
                </div>
                <div class="overflow-y-scroll max-h-screen">
                    <form action="{{URL('/periksa')}}" method="GET">
                        @if ($penyakit)
                            @foreach ($penyakit as $key => $sakit)
                                <div class="shadow-lg md:w-10/12 mx-auto p-2 my-4">
                                    <p>{{ "Pertanyaan " . ($key) }}</p>
